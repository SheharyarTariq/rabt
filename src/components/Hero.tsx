...
export default function Hero() {
  return (
    <section className="relative min-h-[100vh] overflow-hidden bg-ink">
      <div className="absolute inset-0 bg-radial-maroon" />
      <div className="film-grain" />
      <div className="vignette" />

      <div
        className="relative z-10 flex min-h-[100vh] items-center px-6 md:px-10 pt-28"
      >
        <div className="mx-auto max-w-[1400px] w-full grid md:grid-cols-12 gap-10 items-center">
          <div className="md:col-span-8">
            ...
            <AnimatedHeadline
              text="The Art of Rabt."
              className="text-6xl md:text-[9rem] text-gradient-gold"
            />
          ...
          >
            <div className="relative w-full aspect-square max-w-[420px]">
              <div className="absolute inset-0 rounded-full bg-gradient-to-br from-gold-400/15 via-transparent to-maroon-700/30 opacity-70" />
              <Image
                ...
                sizes="420px"
                priority
                className="object-contain relative z-10 drop-shadow-[0_0_40px_rgba(189,149,62,0.25)]"
              />
            </div>
          </motion.div>
        </div>
